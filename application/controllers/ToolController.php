...
class ToolController extends AbstractController
{
    ...
    public function notificationAction($product, $platform, $ext)
    {
        ...
        $randomdelays = array(1000, 3000, 5000, 10000);
        ...
        $view->setVars(array(
            ...
            'layout'            => isset($_GET['notificationeffect']) ? $effects[$_GET['notificationeffect']] : 'growl',
            ...
            'delay'             => isset($_GET['notificationdelay']) && is_numeric($_GET['notificationdelay']) ? ($_GET['notificationdelay'] * 1000) : $randomdelays[rand(0,3)],
